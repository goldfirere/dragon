...
Lemma fix_dom_correct : forall Si dom dom' n n' (w : substn Si dom n)
                               (w' : substn Si dom' n') t,
  apply w t = apply (fix_dom w w') t.
Proof.
  intros. gen w w'. induction t; intros; try apply_commutes; auto.
  - induction w.
    * simpl. 
...
Proof.
  introv Hn1 Hn2 Hleft_eq Hright_eq.
